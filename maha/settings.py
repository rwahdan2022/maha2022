...
LINODE_BUCKET_ACCESS_KEY=os.environ.get('LINODE_BUCKET_ACCESS_KEY', 'PPZKY8RRD9KGPILJ3EMJ') 
LINODE_BUCKET_SECRET_KEY=os.environ.get('LINODE_BUCKET_SECRET_KEY', '1MingwheBUoF8CWhrW3eNAizNTmrxiPdB0kzXglc') 
